...
function updatePreview() {
    ...
    if (isWiki) {
        ...
        if (isMid && isPost) lines.push(style === "simple" ? "Mid-Credits Scene\nPost-Credits Scene" : "🍿 Mid & Post-Credits Scenes");
        ...
        else if (!isBloopers || !configShowBloopers) lines.push(style === "simple" ? "No Bonus Scenes" : "🏃‍♂️ Nothing But Credits");
    }
    ...
    if (configShowSource) {
        let mockSource = isWiki ? "Wikipedia" : (isMid || isPost || isBloopers || isSequel ? "AfterCredits" : "Aggregated");
